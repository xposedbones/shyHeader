...
(function() {
  $.fn.shyHeader = function(options) {
    var currentOffset, defaults, downHandler, gotScrollPos, isHidden, lastScrollPos, lastScrollPosUp, reachedFooter, scrollHandler, startingPos, upHandler, _debounceTimer;
    ...
    $(window).on("scroll", function() {
      return $(window).trigger("shy-scroll");
    });
